...
public class EmployeeDao {
    ...
    public boolean actualizarUsuario(int employeeNumber, String lastname, String firstname, String extension, String email, int officeCode, int reportsTo, String jobTitle){
        boolean flag = false;
        try{
            con = Conexion.getConnection();
            ...
            System.out.println("Error en el metodo actualizarUsuario en la clase EmployeeDao");
        }finally {
            try {
                rs.close();
                pstm.close();
