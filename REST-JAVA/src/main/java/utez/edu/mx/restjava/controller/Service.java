...
public class Service {
    ...
    public boolean createEmployee(int employeeNumber, String lastName, String firstName, String extension, String email, int officeCode, int reportsTo, String jobTitle){
        boolean flag = false;
        try {
    ...
    @Path("/employee")
    @Produces(MediaType.APPLICATION_JSON)
    public boolean updateEmployee(int employeeNumber, String lastName, String firstName, String extension, String email, int officeCode, int reportsTo, String jobTitle){
        boolean flag = false;
        try {
            flag = new EmployeeDao().actualizarUsuario(employeeNumber, lastName, firstName, extension, email, officeCode, reportsTo, jobTitle);
        } catch (Exception e) {
            e.printStackTrace();
        }
